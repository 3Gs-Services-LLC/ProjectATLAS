# north-carolina / sensor-observations

**Periodic numeric readings from fixed instruments.** Road-weather (RWIS) and atmospheric sensors, pavement-surface state, traffic counts and speed detectors, river and stream gauges, air-quality monitors - repeated measurements of the same instrument over time.
