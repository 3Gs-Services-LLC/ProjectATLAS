...
- [ ] Continue Phase 1 research against the remaining source families in §6 below / `Project ATLAS-WebSite.md` §63 — thirty-three source-family investigations across seven batches so far, tracked authoritatively in a **Coverage Matrix** at the top of `docs/research/PHASE1-SOURCE-VERIFICATION.md` (state-by-state tracker: nationwide 511/DOT at 7/50 states, OSM camera-tag discovery at 1/50). Check that matrix first before assuming a family is untouched. Only emergency response data (fire/EMS/police/CAD feeds) remains entirely UNSTARTED.
- [x] **ArcGIS REST discovery: full 758-match set mined, methodology confirmed nationally scaling (2026-08-24).** Seven states verified end-to-end: WA (1,533), OR (1,164), IA (1,251), MD (552), GA (3,676 active / 7,083 total — anomaly resolved, see below), UT (1,437 — corrected, see below), FL (4,057 — new). Deprioritize blind per-state URL guessing (the Colorado/TxDOT approach) in favor of this for the rest of the 511/DOT sweep (`docs/research/PHASE1-SOURCE-VERIFICATION.md` §24, §28).
